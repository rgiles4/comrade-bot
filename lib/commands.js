    ...
    { // Upvote a user
        ...
        async execute(interaction) {
            ...
            if (onCooldown) {
                ...
                await interaction.reply('You can only upvote once every 30 minutes. Please wait before upvoting again.');
                return;
    ...
    { // Downvote a user
        ...
        async execute(interaction) {
            ...
            if (onCooldown) {
                ...
                await interaction.reply('You can only downvote once every 30 minutes. Please wait before upvoting again.');
                return;
            } else if (targetUser.id === interaction.user.id) {
